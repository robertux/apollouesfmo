...
//   if (!dl('gd.so')) {
	   ...
	   //En el servidor no esta habilitada la carga dinamica de librerias, por lo que se ha comentado lo de arriba y se deja FALSE por defecto el Gd.
	   //De todos modos, no hay necesidad de editar imagenes desde el sitio.
       //$GDok = FALSE;
	   $GDok = TRUE;
//   }
//}
