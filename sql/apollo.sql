...
INSERT INTO `apollo`.`docente` VALUES  (1,'Apellidos modificables','Nombres modificables','Licenciado en Contaduria',1,'<p>Descripcion mas corta, pero nodificable.</p>'),
...
INSERT INTO `apollo`.`docente` VALUES  (4,'Apellidos4','Nombres4','Licenciado en ...',1,'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin quis massa sed dolor sodales dapibus. Vestibulum congue, nisi rhoncus facilisis scelerisque, neque neque aliquam velit, eu laoreet nibh massa non turpis. Ut sed neque vehicula erat tincidunt dapibus. Curabitur a est. Nulla lectus metus, pretium et, porta non, rutrum sed, lectus. In vitae sapien a dui rhoncus auctor. Cras adipiscing, nibh a adipiscing consequat, tortor sapien convallis nisi, sit amet dapibus justo nisl nec massa. Etiam dolor nisi, convallis nec, fringilla sed, commodo a, dui. In condimentum eros eget leo. Morbi porta erat vitae nunc. Cras commodo dui quis justo. Fusce dignissim pretium ipsum. Vivamus a mi sed metus posuere consectetuer. Morbi lacinia magna ut enim. Aliquam erat volutpat. Suspendisse laoreet, nulla at blandit mollis, velit nunc pulvinar mauris, in pellentesque erat odio eu arcu. Donec commodo nisl ut dui. Phasellus lectus risus, interdum vel, aliquam eget, accumsan vel, purus. Donec scelerisque tincidunt dui. '),
 (5,'Apellidos5','Nombres5','Licenciado en ...',1,'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin quis massa sed dolor sodales dapibus. Vestibulum congue, nisi rhoncus facilisis scelerisque, neque neque aliquam velit, eu laoreet nibh massa non turpis. Ut sed neque vehicula erat tincidunt dapibus. Curabitur a est. Nulla lectus metus, pretium et, porta non, rutrum sed, lectus. In vitae sapien a dui rhoncus auctor. Cras adipiscing, nibh a adipiscing consequat, tortor sapien convallis nisi, sit amet dapibus justo nisl nec massa. Etiam dolor nisi, convallis nec, fringilla sed, commodo a, dui. In condimentum eros eget leo. Morbi porta erat vitae nunc. Cras commodo dui quis justo. Fusce dignissim pretium ipsum. Vivamus a mi sed metus posuere consectetuer. Morbi lacinia magna ut enim. Aliquam erat volutpat. Suspendisse laoreet, nulla at blandit mollis, velit nunc pulvinar mauris, in pellentesque erat odio eu arcu. Donec commodo nisl ut dui. Phasellus lectus risus, interdum vel, aliquam eget, accumsan vel, purus. Donec scelerisque tincidunt dui. ');
INSERT INTO `apollo`.`docente` VALUES  (6,'Appllds1','Nmbrs1','Lic.',1,'<p>blah</p><p>blah</p><p>blah</p>'),
 (7,'Aplls2','Nmbrs2','Lic.',1,'<p>[...]</p><p>.</p><p>.</p><p>.</p>');
UNLOCK TABLES;
...
INSERT INTO `apollo`.`novedades` VALUES  (17,'Nuevo Post de Pruebas','','<p>Contenido del nuevo post</p>','2008-07-25 00:00:00'),
 ...
 (18,'Primera Entrega de Prueba','','<p>Para mÃ¡s informacion lea este articulo:</p><p>','2008-07-04 00:00:00'),
 ...
 (22,'Prueba de Insercion111','','<p>Contenido del nuevo post</p><p>[modificaciones]</p><p>','2008-08-01 00:00:00'),
 (23,'Prueba de Insercion 2','','<p>Contenido del nuevo post</p>','2008-07-24 00:00:00'),
 (24,'Inicio del Proyecto','','<p><a href=\"http://apollo-uesfmo.blogspot.com/2008/03/damos-inicio.html\" target=\"_self\" title=\"Inicio del proyecto.\">Lea mÃ¡s sobre el inicio de este proyecto en el Blog del mismo.</a></p><p>','2008-03-12 00:00:00'),
 (29,'Tercera Revision Enviada','','<p>Otra revision enviada, lea mas en este articulo:</p><p><a href=\"http://apollo-uesfmo.blogspot.com/2008/08/110808-otra-revision-enviada.html\" title=\"http://apollo-uesfmo.blogspot.com/2008/08/110808-otra-revision-enviada.html\">http://apollo-uesfmo.blogspot.com/2008/08/110808-otra-revision-enviada.html</a></p>','2008-08-11 00:00:00');
INSERT INTO `apollo`.`novedades` VALUES  (28,'Segunda Entrega de Prueba','','<p>Para mÃ¡s informacion lea este articulo:</p><p><a href=\"http://apollo-uesfmo.blogspot.com/2008/07/160708-otra-revision-entregada.html\" title=\"http://apollo-uesfmo.blogspot.com/2008/07/160708-otra-revision-entregada.html\">http://apollo-uesfmo.blogspot.com/2008/07/160708-otra-revision-entregada.html</a></p>','2008-07-16 00:00:00');
UNLOCK TABLES;
...
INSERT INTO `apollo`.`postgrado` VALUES  (1,'Maestría y Técnicas de Investigación Social',7,'Objetivos:\r\nFormar teórica y metodológicamente recurso humano especializado en investigación cuantitativa y cualitativa que contribuya al desarrollo del conocimiento cientifico a nivel regional y nacional.\r\nDesarrollar competencias en la planificacion, ejecucion y presentacion de informes de investigacion.\r\nGenerar sensibilidad por el estudio de aquellas problematicas sociales de interés nacional, que permitan la reflexión, el análisis y la propuesta de alternativas de solución.\r\n\r\nPoblación a la que se dirige el programa:\r\nLicenciados, Ingenieros, Máster o Doctores graduados de la Universidad debidamente autorizados por el Ministerio de Educación.',NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,0),
 (2,'Maestría en Consultoría Empresarial',7,'Vision:\r\nSer lideres en la formación de profesionales a nivel de maestría, mejorando continuamente la calidad académica e incorporando en los planes de estudio contenidos programáticos que faciliten la efectiva ejecución de la gestión y consultoría empresarial.\r\nMision:\r\nFormar profesionales con iniciativa par organizar unidades especificas de negocios, con elevada formación teórico-practica para enfrentar los retos que demande el actual desarrollo empresarial y social.',NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,0),
 (3,'Maestria en Profesionalizacion de la Docencia Superior',7,'<p>El programa de maestria en profesionalizacion de la docencia superior nacio en un convenio entre la Universidad de El Salvador (UES) y la facultad de estudios superiores cuautitlon de la Universidad Autonoma de Mexico (UNAM) en 1994. Se han graduado ya de este programa, diversos profesionales que laboran en instituciones publicas y privadas de todo el pais. Vision: La alta formacion de cuadros academicos y profesionales, asi como la generacion de conocimientos mediante la investigacion del que hacer educativo de la zona occidental del pais; con el objeto de fortalecer los procesos de ensenanza-aprendizaje en los distintos niveles del sistema educativo nacional y la produccion academica en funcion de la cualificacion de la educacion en general y la universitaria en particular. Mision: La construccion de la educacion y de una docencia universitaria de la zona occidental del pais, como objeto de estudio, y su visualizacion como fenomeno socio-cultural asequible desde una prespectiva teorica transdisciplinar y una practica untimamente ligada a los campos social, economico y politico; tomando como base la ensenanza integral desd ela perspectiva teorica practica en el enfoque metodologico del trabajo analitico.</p>','2008-08-22 00:00:00','Master','<p>Poblacion</p>','<p>Horario</p>',35,'MP-0001','<p>Mision de la maestria</p>','<p>Vision de la Maestria</p>','Desarrollo del programa','de tres a seis meses',0);
UNLOCK TABLES;
